...
#   --e_layers 1 \
#   --valid_last \
#   --test_dir multinodeforecast_ETTh1_timer_xl_MultivariateDatasetBenchmark_sl4704_it672_ot672_lr0.0001_bt32_wd0_el1_dm1024_dff2048_nh8_cosFalse_test_0
# done