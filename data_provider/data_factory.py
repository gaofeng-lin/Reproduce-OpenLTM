...
def data_provider(args, flag):
    ...
    if flag in ['train', 'val']:
        data_set = Data(
            ...
            flag=flag,
            size=[args.seq_len, args.input_token_len, args.output_token_len, args.output_len],
        ...
        data_set = Data(
            ...
            data_path=args.data_path,
            flag=flag,
            size=[args.test_seq_len, args.input_token_len, args.test_pred_len, args.output_len],
            nonautoregressive=args.nonautoregressive,
            test_flag=args.test_flag,
            subset_rand_ratio=args.subset_rand_ratio
        )
